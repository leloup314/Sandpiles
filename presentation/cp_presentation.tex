...
\usepackage{scalerel}
\usepackage{tikz}
\graphicspath{{./pics/}{./gif/}{../analysis/avalanche_formations/}{../analysis/moment_analysis/plots/}{../analysis/naive_fits/}}
...
\begin{document}
	...
	\begin{frame}{Sandpile dynamics -- Avalanche evolution}
		\begin{figure}[h]
			...
			\begin{center}
			\animategraphics[width=0.75\textwidth, loop, autoplay]{24}{frame_}{0}{300}
			\caption{Avalanche evolution in a 2 dimensional sandbox (BTW)}
			\end{center}
		\end{figure}
	\end{frame}
