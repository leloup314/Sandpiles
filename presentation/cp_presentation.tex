...
\begin{document}
	...
	\begin{frame}{Sandpile dynamics -- Avalanche evolution}
		\begin{figure}[h]
			...
			\centering
			\only<1>{
			\subfigure[BTW model]{\animategraphics[width=0.45\textwidth, loop, autoplay]{15}{btw_random_}{1}{250}}
			\subfigure[Custom model]{\animategraphics[width=0.45\textwidth, loop, autoplay]{15}{custom_random_}{1}{250}}
			\caption{Avalanche evolution in a 2 dimensional sandbox of length 50 (\textbf{random} drives)}}
			\only<2>{
			\subfigure[BTW model]{\animategraphics[width=0.45\textwidth, loop, autoplay]{15}{btw_center_}{1}{250}}
			\subfigure[Custom model]{\animategraphics[width=0.45\textwidth, loop, autoplay]{15}{custom_center_}{1}{250}}
			\caption{Avalanche evolution in a 2 dimensional sandbox of length 50 (\textbf{center} drives)}}
		\end{figure}
	\end{frame}
	...
	\begin{frame}{Sandpile dynamics -- Avalanche formation}
		\begin{figure}[h]
			...
			\begin{center}
				\only<1>{
				\subfigure[2 D]{\includegraphics[width=0.45\textwidth]{Avalanche_2d_btw_1.png}}
				\subfigure[3 D]{\includegraphics[width=0.45\textwidth]{Avalanche_3d_btw_6.png}}
				\caption{Avalanche formation in the BTW model.}}
				\only<2>{
				\subfigure[2 D]{\includegraphics[width=0.45\textwidth]{Avalanche_2d_custom_11.png}}
				\subfigure[3 D]{\includegraphics[width=0.45\textwidth]{Avalanche_3d_custom_4.png}}
