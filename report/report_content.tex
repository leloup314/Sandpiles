...
\subsection{Simple power law scaling}
\label{app:naiveFit}
\centering
\includegraphics[width=\linewidth]{naive_fits/naive_fit_report}
%	\captionsetup{width=0.75\linewidth}
\captionof{figure}{Naive straight line fit to the raw log-log plot of the avalanche duration distribution 
	(BTW model, $100\times 100$ lattice) for obtaining the critical exponent $\alpha$.}
\label{fig:naiveFit}
%\end{minipage}
%\begin{minipage}[t]{0.5\linewidth}
...
%	\captionsetup{width=0.75\linewidth}
\captionof{figure}{Fitting of first and second avalanche size moments for a three-dimensional sandbox (BTW model).
...
\begin{table}[htb]
	\centering
%	\captionsetup{width=0.525\linewidth}
